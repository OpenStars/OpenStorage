...
const std::map<int, const char*> _TErrorCode_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(12, _kTErrorCodeValues, _kTErrorCodeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->error = (TErrorCode::type)ecast10;
...
TItemSetResult::~TItemSetResult() throw() {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->error = (TErrorCode::type)ecast13;
          this->__isset.error = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
TPutItemResult::~TPutItemResult() throw() {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->error = (TErrorCode::type)ecast16;
          this->__isset.error = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
TExistedResult::~TExistedResult() throw() {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->error = (TErrorCode::type)ecast19;
          this->__isset.error = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
TExistedResult::TExistedResult(const TExistedResult& other20) {
  error = other20.error;
  existed = other20.existed;
  __isset = other20.__isset;
}
TExistedResult& TExistedResult::operator=(const TExistedResult& other21) {
  error = other21.error;
...
TMultiPutItemResult::~TMultiPutItemResult() throw() {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->error = (TErrorCode::type)ecast22;
          this->__isset.error = true;
        } else {
          xfer += iprot->skip(ftype);
        }
