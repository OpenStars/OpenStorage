...
class TStringBigSetKVServiceIfSingletonFactory : virtual public TStringBigSetKVServiceIfFactory {
 public:
  TStringBigSetKVServiceIfSingletonFactory(const ::std::shared_ptr<TStringBigSetKVServiceIf>& iface) : iface_(iface) {}
  virtual ~TStringBigSetKVServiceIfSingletonFactory() {}

  virtual TStringBigSetKVServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(TStringBigSetKVServiceIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<TStringBigSetKVServiceIf> iface_;
};

class TStringBigSetKVServiceNull : virtual public TStringBigSetKVServiceIf {
 public:
  virtual ~TStringBigSetKVServiceNull() {}
  void bsPutItem(TPutItemResult& /* _return */, const TStringKey& /* bsName */, const TItem& /* item */) override {
    return;
  }
  bool bsRemoveItem(const TStringKey& /* bsName */, const TItemKey& /* itemKey */) override {
    bool _return = false;
    return _return;
  }
  void bsExisted(TExistedResult& /* _return */, const TStringKey& /* bsName */, const TItemKey& /* itemKey */) override {
    return;
  }
  void bsGetItem(TItemResult& /* _return */, const TStringKey& /* bsName */, const TItemKey& /* itemKey */) override {
    return;
  }
  void bsGetSlice(TItemSetResult& /* _return */, const TStringKey& /* bsName */, const int32_t /* fromPos */, const int32_t /* count */) override {
    return;
  }
  void bsGetSliceFromItem(TItemSetResult& /* _return */, const TStringKey& /* bsName */, const TItemKey& /* fromKey */, const int32_t /* count */) override {
    return;
  }
  void bsGetSliceR(TItemSetResult& /* _return */, const TStringKey& /* bsName */, const int32_t /* fromPos */, const int32_t /* count */) override {
    return;
  }
  void bsGetSliceFromItemR(TItemSetResult& /* _return */, const TStringKey& /* bsName */, const TItemKey& /* fromKey */, const int32_t /* count */) override {
    return;
  }
  void bsRangeQuery(TItemSetResult& /* _return */, const TStringKey& /* bsName */, const TItemKey& /* startKey */, const TItemKey& /* endKey */) override {
    return;
  }
  void bsMultiPut(TMultiPutItemResult& /* _return */, const TStringKey& /* bsName */, const TItemSet& /* setData */, const bool /* getAddedItems */, const bool /* getReplacedItems */) override {
    return;
  }
  int64_t getTotalCount(const TStringKey& /* bsName */) override {
    int64_t _return = 0;
    return _return;
  }
  int64_t removeAll(const TStringKey& /* bsName */) override {
    int64_t _return = 0;
    return _return;
  }
};
...
class TStringBigSetKVService_bsPutItem_args {
 public:
  ...
  TStringBigSetKVService_bsPutItem_args() noexcept
                                        : bsName() {
  }

  virtual ~TStringBigSetKVService_bsPutItem_args() noexcept;
  TStringKey bsName;
  TItem item;
...
class TStringBigSetKVService_bsPutItem_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsPutItem_pargs() noexcept;
...
class TStringBigSetKVService_bsPutItem_result {
 public:
  ...
  TStringBigSetKVService_bsPutItem_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsPutItem_result() noexcept;
...
class TStringBigSetKVService_bsPutItem_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsPutItem_presult() noexcept;
  TPutItemResult* success;
...
class TStringBigSetKVService_bsRemoveItem_args {
 public:
  ...
  TStringBigSetKVService_bsRemoveItem_args() noexcept
                                           : bsName(),
                                             itemKey() {
  }

  virtual ~TStringBigSetKVService_bsRemoveItem_args() noexcept;
  TStringKey bsName;
  TItemKey itemKey;
...
class TStringBigSetKVService_bsRemoveItem_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsRemoveItem_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_bsRemoveItem_result {
 public:
  ...
  TStringBigSetKVService_bsRemoveItem_result(const TStringBigSetKVService_bsRemoveItem_result&) noexcept;
  TStringBigSetKVService_bsRemoveItem_result& operator=(const TStringBigSetKVService_bsRemoveItem_result&) noexcept;
  TStringBigSetKVService_bsRemoveItem_result() noexcept
                                             : success(0) {
  }

  virtual ~TStringBigSetKVService_bsRemoveItem_result() noexcept;
  bool success;
...
class TStringBigSetKVService_bsRemoveItem_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsRemoveItem_presult() noexcept;
  bool* success;
...
class TStringBigSetKVService_bsExisted_args {
 public:
  ...
  TStringBigSetKVService_bsExisted_args() noexcept
                                        : bsName(),
                                          itemKey() {
  }

  virtual ~TStringBigSetKVService_bsExisted_args() noexcept;
  TStringKey bsName;
  TItemKey itemKey;
...
class TStringBigSetKVService_bsExisted_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsExisted_pargs() noexcept;
  const TStringKey* bsName;
  const TItemKey* itemKey;
...
class TStringBigSetKVService_bsExisted_result {
 public:
  ...
  TStringBigSetKVService_bsExisted_result(const TStringBigSetKVService_bsExisted_result&) noexcept;
  TStringBigSetKVService_bsExisted_result& operator=(const TStringBigSetKVService_bsExisted_result&) noexcept;
  TStringBigSetKVService_bsExisted_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsExisted_result() noexcept;
...
class TStringBigSetKVService_bsExisted_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsExisted_presult() noexcept;
  TExistedResult* success;
...
class TStringBigSetKVService_bsGetItem_args {
 public:
  ...
  TStringBigSetKVService_bsGetItem_args() noexcept
                                        : bsName(),
                                          itemKey() {
  }

  virtual ~TStringBigSetKVService_bsGetItem_args() noexcept;
  TStringKey bsName;
  TItemKey itemKey;
...
class TStringBigSetKVService_bsGetItem_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetItem_pargs() noexcept;
  const TStringKey* bsName;
  const TItemKey* itemKey;
...
class TStringBigSetKVService_bsGetItem_result {
 public:
  ...
  TStringBigSetKVService_bsGetItem_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsGetItem_result() noexcept;
  TItemResult success;
...
class TStringBigSetKVService_bsGetItem_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetItem_presult() noexcept;
  TItemResult* success;
...
class TStringBigSetKVService_bsGetSlice_args {
 public:
  ...
  TStringBigSetKVService_bsGetSlice_args() noexcept
                                         : bsName(),
                                           fromPos(0),
                                           count(0) {
  }

  virtual ~TStringBigSetKVService_bsGetSlice_args() noexcept;
  TStringKey bsName;
  int32_t fromPos;
  int32_t count;
...
class TStringBigSetKVService_bsGetSlice_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSlice_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_bsGetSlice_result {
 public:
  ...
  TStringBigSetKVService_bsGetSlice_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsGetSlice_result() noexcept;
...
class TStringBigSetKVService_bsGetSlice_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSlice_presult() noexcept;
  TItemSetResult* success;
...
class TStringBigSetKVService_bsGetSliceFromItem_args {
 public:
  ...
  TStringBigSetKVService_bsGetSliceFromItem_args() noexcept
                                                 : bsName(),
                                                   fromKey(),
                                                   count(0) {
  }

  virtual ~TStringBigSetKVService_bsGetSliceFromItem_args() noexcept;
  TStringKey bsName;
  TItemKey fromKey;
  int32_t count;
...
class TStringBigSetKVService_bsGetSliceFromItem_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSliceFromItem_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_bsGetSliceFromItem_result {
 public:
  ...
  TStringBigSetKVService_bsGetSliceFromItem_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsGetSliceFromItem_result() noexcept;
  TItemSetResult success;
...
class TStringBigSetKVService_bsGetSliceFromItem_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSliceFromItem_presult() noexcept;
  TItemSetResult* success;
...
class TStringBigSetKVService_bsGetSliceR_args {
 public:
  ...
  TStringBigSetKVService_bsGetSliceR_args() noexcept
                                          : bsName(),
                                            fromPos(0),
                                            count(0) {
  }

  virtual ~TStringBigSetKVService_bsGetSliceR_args() noexcept;
  TStringKey bsName;
  int32_t fromPos;
  int32_t count;
...
class TStringBigSetKVService_bsGetSliceR_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSliceR_pargs() noexcept;
  const TStringKey* bsName;
  const int32_t* fromPos;
  const int32_t* count;
...
class TStringBigSetKVService_bsGetSliceR_result {
 public:
  ...
  TStringBigSetKVService_bsGetSliceR_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsGetSliceR_result() noexcept;
  TItemSetResult success;
...
class TStringBigSetKVService_bsGetSliceR_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSliceR_presult() noexcept;
  TItemSetResult* success;
...
class TStringBigSetKVService_bsGetSliceFromItemR_args {
 public:
  ...
  TStringBigSetKVService_bsGetSliceFromItemR_args() noexcept
                                                  : bsName(),
                                                    fromKey(),
                                                    count(0) {
  }

  virtual ~TStringBigSetKVService_bsGetSliceFromItemR_args() noexcept;
  TStringKey bsName;
  TItemKey fromKey;
  int32_t count;
...
class TStringBigSetKVService_bsGetSliceFromItemR_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSliceFromItemR_pargs() noexcept;
  const TStringKey* bsName;
  const TItemKey* fromKey;
  const int32_t* count;
...
class TStringBigSetKVService_bsGetSliceFromItemR_result {
 public:
  ...
  TStringBigSetKVService_bsGetSliceFromItemR_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsGetSliceFromItemR_result() noexcept;
  TItemSetResult success;
...
class TStringBigSetKVService_bsGetSliceFromItemR_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsGetSliceFromItemR_presult() noexcept;
  TItemSetResult* success;
...
class TStringBigSetKVService_bsRangeQuery_args {
 public:
  ...
  TStringBigSetKVService_bsRangeQuery_args() noexcept
                                           : bsName(),
                                             startKey(),
                                             endKey() {
  }

  virtual ~TStringBigSetKVService_bsRangeQuery_args() noexcept;
  TStringKey bsName;
  TItemKey startKey;
  TItemKey endKey;
...
class TStringBigSetKVService_bsRangeQuery_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsRangeQuery_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_bsRangeQuery_result {
 public:
  ...
  TStringBigSetKVService_bsRangeQuery_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsRangeQuery_result() noexcept;
  TItemSetResult success;
...
class TStringBigSetKVService_bsRangeQuery_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsRangeQuery_presult() noexcept;
  TItemSetResult* success;
...
class TStringBigSetKVService_bsMultiPut_args {
 public:
  ...
  TStringBigSetKVService_bsMultiPut_args() noexcept
                                         : bsName(),
                                           getAddedItems(0),
                                           getReplacedItems(0) {
  }

  virtual ~TStringBigSetKVService_bsMultiPut_args() noexcept;
  TStringKey bsName;
  TItemSet setData;
  bool getAddedItems;
...
class TStringBigSetKVService_bsMultiPut_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_bsMultiPut_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_bsMultiPut_result {
 public:
  ...
  TStringBigSetKVService_bsMultiPut_result() noexcept {
  }

  virtual ~TStringBigSetKVService_bsMultiPut_result() noexcept;
...
class TStringBigSetKVService_bsMultiPut_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_bsMultiPut_presult() noexcept;
  TMultiPutItemResult* success;
...
class TStringBigSetKVService_getTotalCount_args {
 public:
  ...
  TStringBigSetKVService_getTotalCount_args() noexcept
                                            : bsName() {
  }

  virtual ~TStringBigSetKVService_getTotalCount_args() noexcept;
  TStringKey bsName;
...
class TStringBigSetKVService_getTotalCount_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_getTotalCount_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_getTotalCount_result {
 public:
  ...
  TStringBigSetKVService_getTotalCount_result(const TStringBigSetKVService_getTotalCount_result&) noexcept;
  TStringBigSetKVService_getTotalCount_result& operator=(const TStringBigSetKVService_getTotalCount_result&) noexcept;
  TStringBigSetKVService_getTotalCount_result() noexcept
                                              : success(0) {
  }

  virtual ~TStringBigSetKVService_getTotalCount_result() noexcept;
  int64_t success;
...
class TStringBigSetKVService_getTotalCount_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_getTotalCount_presult() noexcept;
  int64_t* success;
...
class TStringBigSetKVService_removeAll_args {
 public:
  ...
  TStringBigSetKVService_removeAll_args() noexcept
                                        : bsName() {
  }

  virtual ~TStringBigSetKVService_removeAll_args() noexcept;
  TStringKey bsName;
...
class TStringBigSetKVService_removeAll_pargs {
 public:
  ...
  virtual ~TStringBigSetKVService_removeAll_pargs() noexcept;
  const TStringKey* bsName;
...
class TStringBigSetKVService_removeAll_result {
 public:
  ...
  TStringBigSetKVService_removeAll_result(const TStringBigSetKVService_removeAll_result&) noexcept;
  TStringBigSetKVService_removeAll_result& operator=(const TStringBigSetKVService_removeAll_result&) noexcept;
  TStringBigSetKVService_removeAll_result() noexcept
                                          : success(0) {
  }

  virtual ~TStringBigSetKVService_removeAll_result() noexcept;
  int64_t success;
...
class TStringBigSetKVService_removeAll_presult {
 public:
  ...
  virtual ~TStringBigSetKVService_removeAll_presult() noexcept;
  int64_t* success;
...
class TStringBigSetKVServiceClient : virtual public TStringBigSetKVServiceIf {
 public:
  TStringBigSetKVServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  TStringBigSetKVServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class TStringBigSetKVServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  TStringBigSetKVServiceProcessor(::std::shared_ptr<TStringBigSetKVServiceIf> iface) :
    iface_(iface) {
...
class TStringBigSetKVServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  TStringBigSetKVServiceProcessorFactory(const ::std::shared_ptr< TStringBigSetKVServiceIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< TStringBigSetKVServiceIfFactory > handlerFactory_;
};

class TStringBigSetKVServiceMultiface : virtual public TStringBigSetKVServiceIf {
 public:
  TStringBigSetKVServiceMultiface(std::vector<std::shared_ptr<TStringBigSetKVServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~TStringBigSetKVServiceMultiface() {}
 protected:
  std::vector<std::shared_ptr<TStringBigSetKVServiceIf> > ifaces_;
  TStringBigSetKVServiceMultiface() {}
  void add(::std::shared_ptr<TStringBigSetKVServiceIf> iface) {
...
class TStringBigSetKVServiceConcurrentClient : virtual public TStringBigSetKVServiceIf {
 public:
  TStringBigSetKVServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  TStringBigSetKVServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
